...
// =======
    updateSubmit(){
        ...
        componentDidUpdate(prevProps, prevState){
            ...
            // if(prevState.first_name !== this.state.first_name || prevState.last_name !== this.state.last_name || prevState.email !== this.state.email || prevState.contact_number !== this.state.contact_number || prevState.city !== this.state.city || prevState.zip_code !== this.state.zip_code){
            //     this.updateSubmit();
            // }
             ...
             >
                 <View style={styles.modal}>
                    ...
                    <View style={styles.inputWrap}>
                        <TextInput style={styles.inputBox2} placeholder="First Name" defaultValue={this.state.first_name} onChangeText={(first_name) => this.setState({first_name})} />
                        <TextInput style={styles.inputBox2} placeholder="Last Name" defaultValue={this.state.last_name} onChangeText={(last_name) => this.setState({last_name})} />
                    </View>
                    <View style={styles.inputWrap}>
                        <TextInput style={styles.inputBox2} placeholder="Email" keyboardType="email-address" defaultValue={this.state.email} onChangeText={(email) => this.setState({email})} />
                        <TextInput style={styles.inputBox2} placeholder="Phone Number" keyboardType="phone-pad" defaultValue={this.state.contact_number} onChangeText={(contact_number) => this.setState({contact_number})} />
                    </View>
                    <TextInput style={styles.inputBox} placeholder="City" defaultValue={this.state.city} onChangeText={(city) => this.setState({city})} />
                    <TextInput style={styles.inputBox} placeholder="ZIP Code" keyboardType="number-pad" defaultValue={this.state.zip_code} onChangeText={(zip_code) => this.setState({zip_code})} />
