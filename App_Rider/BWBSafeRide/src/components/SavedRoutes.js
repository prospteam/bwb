...
export default class SavedRoutes extends Component {
    ...
    onPressPinned(val = null){
        ...
        // Alert.alert("lat: "+JSON.parse(val.pickup_latlong.split(":")[0])+" - long: "+JSON.parse(val.pickup_latlong.split(":")[1]))

        console.log("on press pinned");
        console.log(val);
        console.log("on press pinned");
        ...
        this.props.navigation.navigate('Dashboard',{
            ...
            booking_data_from_lat: JSON.parse(val.pickup_latlong.split(":")[0]),
            booking_data_from_long: JSON.parse(val.pickup_latlong.split(":")[1]),
