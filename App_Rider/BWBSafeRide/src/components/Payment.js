                ...
                <Content style={{margin: 30}}>
                  ...
                  <View style={{ borderWidth: 2, borderColor: '#1c1b22', marginBottom: 5 }}>
                    <Text style={{ backgroundColor: '#e3e3e3', padding: 5 }}>Drop-off Location </Text><Text style={{ padding: 5, fontSize: 14 }}>{params.form_to_text}</Text>
                      ...
                      <View style={{borderWidth: 2, borderColor: '#1c1b22', marginBottom: 5}}>
                        <Text style={{ backgroundColor: '#e3e3e3', padding: 5 }}>
                          Base Fare 
                        </Text>
                      ...
                      <View style={{backgroundColor: '#1c1b22', padding: 10, marginBottom: 5}}>
                        <Text style={{color: '#d3a04c'}}>
                          Total Amount: $ {params.payByDistance.toFixed(2)}
                        </Text>
                      </View>
                    </>
                  ):null }
